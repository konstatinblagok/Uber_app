            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="{{ asset('public/site-asset/images/white.jpg') }}" class="d-block w-100" alt="white">
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Homemade Food Delivered to Your Doorstep</h5>
                            <div class="slider-btn">
                                <a href="{{ route('show.menu') }}" class="btn btn-1">Get it</a>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="{{ asset('public/site-asset/images/grey.jpg') }}" class="d-block w-100" alt="grey">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 id="grey">Get in YOUR KITCHEN and get Paid</h5>
                            <div class="slider-btn">
                                <a href="{{ route('register') }}" class="btn btn-2">Sign up to cook</a>
                            </div>
                        </div>
                    </div>
                </div>
