<!-- Modal -->
<div class="modal fade" id="terms-conditions-modal" tabindex="-1" role="dialog" aria-labelledby="termsConditionsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="termsConditionsModalLabel">
                    Terms and Conditions for <span class="highlight preview_company_name">{{config('app.name')}}</span>
                </h3>
