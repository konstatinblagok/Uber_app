                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="typeForm" action="{{ route('admin.meal.type.update', ['id' => $type->id]) }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="{{ $type->name }}">
