                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 special-grid drinks">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-01.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid drinks">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-02.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid drinks">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-03.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid lunch">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-04.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid lunch">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-05.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid lunch">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-06.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid dinner">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-07.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid dinner">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-08.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
                            ...
                            <div class="col-lg-4 col-md-6 special-grid dinner">
                                <div class="gallery-single fix">
                                    <img src="{{asset('site/images/img-09.jpg')}}" class="img-fluid" alt="Image">
                                    <div class="why-text">
